...
from .params_generator import VideoCommentThreadParamGenerator, AllChannelCommentsThreadParamGenerator
...
class VideoCommentThreadSearchFactory(SearchFactory):
    ...
    def get_search_params_generator(self) -> ParamGenerator:
        return VideoCommentThreadParamGenerator(self.__video_id, max_results=self.__max_results)
...
class AllChannelCommentThreadSearchFactory(SearchFactory):
    ...
    def get_search_params_generator(self) -> ParamGenerator:
        return AllChannelCommentsThreadParamGenerator(self.__channel_id, max_results=self.__max_results)
